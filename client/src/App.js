  ...
  <ExperienceSection>
    <div className="experience-item">
      ...
      <div className="details">
        ...
        <p>
          Founded and engineered DanceLink—comprehensive dance ecosystem with AI-powered event discovery, real-time partner matching, premium subscriptions. Built from zero using Kotlin/Compose, SwiftUI, and React.js with Firebase backend. Delivered 50% conversion improvement, 65% cost reduction, 40% faster matching through intelligent algorithms.
        </p>
        <ul>
          ...
          <li>Designed AI agent-powered event discovery to solve industry fragmentation (inconsistent APIs, mislabeled metadata, missing dance keywords), ensuring users only see accurate and relevant dance events worldwide.</li>
          <li>Built comprehensive event discovery platform integrating Dance Events API, Eventbrite API, and Google Custom Search with real-time caching and intelligent fallback systems—enabling discovery across 5 continents with smart postal code validation.</li>
          <li>Developed advanced partner matching system with bilateral algorithms, real-time notifications, event-based compatibility scoring, and automatic chat creation—reducing matching time by 40% and increasing engagement by 60%.</li>
